...
class MY_Loader extends CI_Loader {
    ...
    public function pagetemplate($template_name, $vars = array(), $return = FALSE)
    {
		$vars['module'] = $template_name;
        $this->view('pagetemplate/header', $vars, $return); // header
        $this->view($template_name, $vars, $return); // view
        $this->view('pagetemplate/footer', $vars, $return); // footer
    }
