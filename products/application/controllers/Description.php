...
:	 * http://example.com/index.php/welcome
	...
	public function index() {
		...
		//print_r($data ['subscribedProductList']); die;
		$prodids = array ();
	...
	public function bookDetail() {
		...
		$val = $this->ProductDescriptionModel->getDetailBooks ( $bookname );
		foreach ( $val as $k => $h ) {
			echo "TITLE:";
			echo "<div class='booktit;'>" . $h->m_boktitle . "</div>";
			echo "</br>";
			echo "DESCRIPTION:";
			echo "<div class='bookdesc' style='text-align:justify;'>" . $h->m_bokdesc . "</div>";
			echo "</br>";
			echo "AUTHOR NAME:";
			echo "<div class='bookauth;'>" . $h->m_bokauthorname . "</div>";
		}
	}
}
